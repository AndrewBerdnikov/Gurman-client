...
const AddRecipePage = observer(() => {
    ...
    const addRecipe = async () => {
        ...
        await setRecipeId(recipes.recipes[recipes.recipes.length - 1].id);
        setName('');
        setFile(null);
        setDescription('');
    }
                ...
                <div className='add-recipe-page-content'>
                    ...
                    <div className='add-recipe-page-info'>
                        ...
                        <div className='add-recipe-page-info-main'>
                            ...
                            <button onClick={addRecipe} className='add-recipe-page-info-main__button'>Добавить рецепт</button>
                        ...
                        <div className='add-recipe-page-info-instruction'>
                            ...
                            <p className='add-recipe-page-info-instruction__item'>6. Укажите ингридиенты"</p>
                            <p className='add-recipe-page-info-instruction__item'>7. Добавте шаги готовки</p>
                            <p className='add-recipe-page-info-instruction__item'>8. Нажмите кнопку "Создать"</p>
                        </div>
                    </div>
                </div>
            </div>
