...
const RecipeSpecial = ({recipes}) => {
    ...
    return (
        <div className='recipe-special' onClick={() => navigate(RECIPEPAGE_ROUTE + "/" + recipes.title)} style={{backgroundImage: `linear-gradient( rgba(58, 56, 56, 0.5), rgba(58, 56, 56, 0.5) ), url(${process.env.REACT_APP_API_URL + '/' +  recipes.img})`}}>
