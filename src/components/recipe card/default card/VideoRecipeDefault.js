...
import { RECIPEPAGE_ROUTE, VIDEORECIPEPAGE_ROUTE } from "../../../utils/consts";
...
const VideoRecipeDefault = observer(({recipe}) => {
    ...
    return ( 
    <div className="recipe-default" onClick={() => navigate(VIDEORECIPEPAGE_ROUTE + "/" + recipe.title)}>
        {/* <img src={process.env.REACT_APP_API_URL + '/' + recipe.img} alt="Картинка рецепта" className="recipe-default__img"/> */}
        <iframe className="recipe-default__video" src={recipe.video}></iframe>
...
export default VideoRecipeDefault;